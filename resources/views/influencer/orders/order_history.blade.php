...
<header>
    <nav class="navbar--verify">
        <div class="back--nav">
            ...
            <span class="header-text verify--text--nav nav-link">Order History</span>
        </div>
    </nav>
</header>
<main>
    ...
    <div class="container-fluid main-pending-container">
        <div class="pending_order_container">
            ...
            <div class="deliver--detail--content pl-1">
                ...
                <div class="btn-order-history">
                    <span class="deliver--span">Delivered</span>
                </div>
            </div>
        </div>
        ...
        <div class="pending_order_container">
            <div class="feature--heading--order mt-1">
                <span style="font-size:15px">Order ID : <b>#2407415041023</b></span>
                <span style="font-size:13px">Date 24/07/24 15:4</span>
            </div>

            <div class="deliver--detail--content pl-3">
                <div class="row deliver--section--row">
                    <div class="col-3 p-0   ">
                        Service :
                    </div>
