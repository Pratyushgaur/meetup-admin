                                                        ...
                                                        <div class="profile--name--section row">
                                                            ...
                                                            <div class="col-6">
                                                                <input type="text" name="name" class="profile--input"
                                                                    require dir="rtl" value="{{ $value->name }}">
                                                            </div>
                                                            <div class="col-6">
                                                            ...
                                                            <div class="details--sections--1">
                                                                ...
                                                                <div class="detail--content--container">
                                                                    <svg xmlns="http://www.w3.org/2000/svg" width="24"
                                                                        ...
                                                                        stroke="currentColor" stroke-width="2"
                                                                        stroke-linecap="round" stroke-linejoin="round"
                                                                        class="feather feather-mail me-1">
                                                                        <path
                                                                ...
                                                                <div class="detail--content--container">
                                                                    <div class="detail--icon--section">
                                                                        <svg xmlns="http://www.w3.org/2000/svg"
                                                                            ...
                                                                            stroke-width="2" stroke-linecap="round"
                                                                            stroke-linejoin="round"
                                                                            class="feather feather-user me-1">
                                                                            <path
                                                                ...
                                                                <div class="detail--content--container">
                                                                    <div class="detail--icon--section">
                                                                        <svg xmlns="http://www.w3.org/2000/svg"
                                                                            ...
                                                                            stroke-width="2" stroke-linecap="round"
                                                                            stroke-linejoin="round"
                                                                            class="feather feather-twitter me-1">
                                                                            <path
                                                                ...
                                                                <div class="detail--content--container">
                                                                    <div class="detail--icon--section">
                                                                        <svg xmlns="http://www.w3.org/2000/svg"
                                                                            ...
                                                                            stroke-width="2" stroke-linecap="round"
                                                                            stroke-linejoin="round"
                                                                            class="feather feather-facebook me-1">
                                                                            <path
                                                                ...
                                                                <div class="detail--content--container">
                                                                    <div class="detail--icon--section">
                                                                        <svg xmlns="http://www.w3.org/2000/svg"
                                                                            ...
                                                                            stroke-width="2" stroke-linecap="round"
                                                                            stroke-linejoin="round"
                                                                            class="feather feather-youtube me-1">
                                                                            <path
                                                                ...
                                                                <div class="detail--content--container">
                                                                    <div class="detail--icon--section">
                                                                        <svg xmlns="http://www.w3.org/2000/svg"
                                                                            ...
                                                                            stroke-width="2" stroke-linecap="round"
                                                                            stroke-linejoin="round"
                                                                            class="feather feather-linkedin me-1">
                                                                            <path
                                                                ...
                                                                <div class="detail--content--container">
                                                                    <div class="detail--icon--section">
                                                                        <svg xmlns="http://www.w3.org/2000/svg"
                                                                            ...
                                                                            stroke-width="2" stroke-linecap="round"
                                                                            stroke-linejoin="round"
                                                                            class="feather feather-instagram me-1">
