    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="PriceModalCenterTitle">Add Gift</h5>
            ...
            <form action="{{ route('admin.masters.gift.submit') }}" method="post" enctype="multipart/form-data">
                @csrf
                ...
                <table id="style-2" class="table style-2 dt-table-hover">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="text-center">
                                @if($value->status == 0)
                                <a href="{{ route('admin.masters.gift.status', $value->id) }}">
                            ...
                            <td class="text-center">
                                <a class="badge badge-light-primary text-start me-2 action-edit edit-btn" href="javascript:void(0);" data-name="{{$value->name}}" data-price="{{$value->price}}" data-logo="{{$value->image}}" data-id="{{$value->id}}">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-edit-3">
                                        <path d="M12 20h9"></path>
                                        <path d="M16.5 3.5a2.121 2.121 0 0 1 3 3L7 19l-4 1 1-4L16.5 3.5z"></path>
                                    </svg>
                                </a>
                                <form action="{{ route('admin.masters.gift.delete') }}" method="post" style="display:inline-block" class="DeletePrice">
                                    @method('delete') @csrf
...
<div class="modal fade" id="EditPriceModalCenter" tabindex="-1" role="dialog" aria-labelledby="EditPriceModalCenterTitle" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="EditPriceModalCenterTitle">Edit Gifts</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close">
                    <svg aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-x">
                        <line x1="18" y1="6" x2="6" y2="18"></line>
                        <line x1="6" y1="6" x2="18" y2="18"></line>
            ...
            <form action="{{ route('admin.masters.editgift.submit') }}" method="post" enctype="multipart/form-data">
                @csrf
                <div class="modal-body">
                    <div class="w-100 d-flex justify-content-center">
                        <div class="avatar avatar-xl">
