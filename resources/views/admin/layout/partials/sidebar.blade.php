     ...
     <nav id="sidebar">
         ...
         <ul class="list-unstyled menu-categories" id="accordionExample">
            ...
            <li class="menu {{Request::is('admin/masters*') ? 'active' : '' }}">
                ...
                <ul class="collapse submenu list-unstyled {{Request::is('admin/masters*') ? 'show' : '' }}"
                    id="masters" data-bs-parent="#accordionExample">
            ...
            <li class="menu {{Request::is('admin/influncers*') ? 'active' : '' }}">
                ...
                <ul class="collapse submenu list-unstyled {{Request::is('admin/influncers*') ? 'show' : '' }}"
                    id="influncers" data-bs-parent="#accordionExample">
                    <li
                        class="{{Request::is('admin/influncers/list') || Request::is('admin/influncers/posts*') ? 'active' : '' }}">
                        <a href="{{route('admin.influncers.list')}}">
                            List
                        </a>
                    </li>
                    <li
                        class="{{Request::is('admin/influncers/pending-order') || Request::is('admin/influncers/orders/view*') ? 'active' : '' }}">
                        <a href="{{route('admin.influncers.pending.order')}}">
                            Pending Orders
                        </a>
                    </li>
                    <li
                        class="{{Request::is('admin/influncers/kyc-verification') || Request::is('admin/influncers/kyc/view*') ? 'active' : '' }}">
            ...
            <li class="menu {{Request::is('admin/users*') ? 'active' : '' }}">
                ...
                <ul class="collapse submenu list-unstyled {{Request::is('admin/users*') ? 'show' : '' }}" id="users"
            ...
            <li class="menu {{Request::is('admin/live*') ? 'active' : '' }}">
                <a href="{{ route('admin.live.list') }}" aria-expanded="false" class="dropdown-toggle">
                    <div class="">
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none"
                            stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
                            class="feather feather-users">
            ...
            <li class="menu {{Request::is('admin/reports*') ? 'active' : '' }}">
                ...
                <ul class="collapse submenu list-unstyled {{Request::is('admin/reports*') ? 'show' : '' }}" id="reports" data-bs-parent="#accordionExample">
                    <li class="{{Request::is('admin/reports/income') ? 'active' : '' }}">
                        <a href="{{route('admin.reports.income')}}"> Income </a>
                    </li>
                    <li class="{{Request::is('admin/reports/deposit') ? 'active' : '' }}">
                        <a href="{{route('admin.reports.deposit')}}"> Deposit </a>
                    </li>
                </ul>
            </li>
            ...
            <!-- <li class="menu {{Request::is('admin/payments*') ? 'active' : '' }}">
                ...
                <ul class="collapse submenu list-unstyled {{Request::is('admin/payments*') ? 'show' : '' }}"
                    id="payments" data-bs-parent="#accordionExample">
                    <li class="{{Request::is('admin/payments/UnSettlements') ? 'active' : '' }}">
                        <a href="{{route('admin.payments.unsettlements')}}">
                            UnSettlements
                        </a>
                    </li>
                    <li class="{{Request::is('admin/payments/Settlements') ? 'active' : '' }}">
            ...
            <li class="menu {{Request::is('admin/business-setup*') ? 'active' : '' }}">
                ...
                <ul class="collapse submenu list-unstyled {{Request::is('admin/business-setup*') ? 'show' : '' }}"
                    id="business_setting" data-bs-parent="#accordionExample">
