...
<head>
    ...
    <link rel="icon" type="image/x-icon" href="{{ URL::TO('admin') }}/src/assets/img/favicon.ico"/>
    <link href="{{ URL::TO('admin') }}/layouts/vertical-dark-menu/css/light/loader.css" rel="stylesheet" type="text/css" />
    <link href="{{ URL::TO('admin') }}/layouts/vertical-dark-menu/css/dark/loader.css" rel="stylesheet" type="text/css" />
    <script src="{{ URL::TO('admin') }}/layouts/vertical-dark-menu/loader.js"></script>

    <!-- BEGIN GLOBAL MANDATORY STYLES -->
    <link href="https://fonts.googleapis.com/css?family=Nunito:400,600,700" rel="stylesheet">
    <link href="{{ URL::TO('admin') }}/src/bootstrap/css/bootstrap.min.css" rel="stylesheet" type="text/css" />
    <link href="{{ URL::TO('admin') }}/layouts/vertical-dark-menu/css/light/plugins.css" rel="stylesheet" type="text/css" />
    <link href="{{ URL::TO('admin') }}/layouts/vertical-dark-menu/css/dark/plugins.css" rel="stylesheet" type="text/css" />
    <!-- END GLOBAL MANDATORY STYLES -->

    <!-- BEGIN PAGE LEVEL PLUGINS/CUSTOM STYLES -->
    <link href="{{ URL::TO('admin') }}/src/plugins/src/apex/apexcharts.css" rel="stylesheet" type="text/css">
    <link href="{{ URL::TO('admin') }}/src/assets/css/light/dashboard/dash_1.css" rel="stylesheet" type="text/css" />
    <link href="{{ URL::TO('admin') }}/src/assets/css/dark/dashboard/dash_1.css" rel="stylesheet" type="text/css" />
...
<body class="layout-boxed">
            ...
            <ul class="navbar-item flex-row ms-lg-auto ms-0">
                ...
                <li class="nav-item dropdown language-dropdown">
                    <a href="javascript:void(0);" class="nav-link dropdown-toggle" id="language-dropdown" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                        <img src="{{ URL::TO('admin') }}/src/assets/img/1x1/us.svg" class="flag-width" alt="flag">
                    </a>
                    <div class="dropdown-menu position-absolute" aria-labelledby="language-dropdown">
                        <a class="dropdown-item d-flex" href="javascript:void(0);"><img src="{{ URL::TO('admin') }}/src/assets/img/1x1/us.svg" class="flag-width" alt="flag"> <span class="align-self-center">&nbsp;USA</span></a>
                        <a class="dropdown-item d-flex" href="javascript:void(0);"><img src="{{ URL::TO('admin') }}/src/assets/img/1x1/tr.svg" class="flag-width" alt="flag"> <span class="align-self-center">&nbsp;Turkey</span></a>
                        <a class="dropdown-item d-flex" href="javascript:void(0);"><img src="{{ URL::TO('admin') }}/src/assets/img/1x1/br.svg" class="flag-width" alt="flag"> <span class="align-self-center">&nbsp;Brazil</span></a>
                        <a class="dropdown-item d-flex" href="javascript:void(0);"><img src="{{ URL::TO('admin') }}/src/assets/img/1x1/in.svg" class="flag-width" alt="flag"> <span class="align-self-center">&nbsp;India</span></a>
                        <a class="dropdown-item d-flex" href="javascript:void(0);"><img src="{{ URL::TO('admin') }}/src/assets/img/1x1/de.svg" class="flag-width" alt="flag"> <span class="align-self-center">&nbsp;Germany</span></a>
                    </div>
                </li>
                        ...
                        <div class="notification-scroll">
                            <div class="dropdown-item">
                                <div class="media server-log">
                                    <img src="{{ URL::TO('admin') }}/src/assets/img/profile-16.jpeg" class="img-fluid me-2" alt="avatar">
                            ...
                            <div class="dropdown-item">
                                <div class="media ">
                                    <img src="{{ URL::TO('admin') }}/src/assets/img/profile-15.jpeg" class="img-fluid me-2" alt="avatar">
                                    <div class="media-body">
                                        <div class="data-info">
                            ...
                            <div class="dropdown-item">
                                <div class="media file-upload">
                                    <img src="{{ URL::TO('admin') }}/src/assets/img/profile-21.jpeg" class="img-fluid me-2" alt="avatar">
                                    <div class="media-body">
                                        <div class="data-info">
                    ...
                    <a href="javascript:void(0);" class="nav-link dropdown-toggle user" id="userProfileDropdown" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                        <div class="avatar-container">
                            <div class="avatar avatar-sm avatar-indicators avatar-online">
                                <img alt="avatar" src="{{ URL::TO('admin') }}/src/assets/img/profile-30.png" class="rounded-circle">
                            </div>
                        </div>
                    </a>
        ...
        <div class="sidebar-wrapper sidebar-theme">
            ...
            <nav id="sidebar">
                ...
                <div class="navbar-nav theme-brand flex-row  text-center">
                    <div class="nav-logo">
                        <div class="nav-item theme-logo">
                            <a href="./index.html">
                                <!-- <img src="{{ URL::TO('admin') }}/src/assets/img/logo.svg" class="navbar-logo" alt="logo"> -->
                            </a>
                        </div>
                ...
                <ul class="list-unstyled menu-categories" id="accordionExample">
                    ...
                    <li class="menu">
                        <a target="_blank" href="{{ URL::TO('admin') }}/{{ URL::TO('admin') }}/documentation/index.html" aria-expanded="false" class="dropdown-toggle">
                            <div class="">
                    ...
                    <li class="menu">
                        <a target="_blank" href="{{ URL::TO('admin') }}/{{ URL::TO('admin') }}/documentation/changelog.html" aria-expanded="false" class="dropdown-toggle">
                            <div class="">
                                    ...
                                    <div class="meta-info">
                                        ...
                                        <div class="avatar--group">
                                            ...
                                            <div class="avatar translateY-axis">
                                                <img alt="avatar" src="{{ URL::TO('admin') }}/src/assets/img/profile-8.jpeg"/>
                                            </div>
                                            <div class="avatar translateY-axis">
                                                <img alt="avatar" src="{{ URL::TO('admin') }}/src/assets/img/profile-12.jpeg"/>
                                            </div>
                                            <div class="avatar translateY-axis">
                                                <img alt="avatar" src="{{ URL::TO('admin') }}/src/assets/img/profile-19.jpeg"/>
                                            </div>
                        ...
                        <div class="col-xl-4 col-lg-6 col-md-6 col-sm-12 col-12 layout-spacing">
                            <div class="widget widget-card-one">
                                <div class="widget-content">
                                    ...
                                    <div class="media">
                                        <div class="w-img">
                                            <img src="{{ URL::TO('admin') }}/src/assets/img/profile-19.jpeg" alt="avatar">
                                        </div>
                                        <div class="media-body">
                                            <h6>Jimmy Turner</h6>
                        ...
                        <div class="col-xl-4 col-lg-6 col-md-6 col-sm-12 col-12 layout-spacing">
                            <div class="widget widget-card-two">
                                <div class="widget-content">
                                    ...
                                    <div class="media">
                                        <div class="w-img">
                                            <img src="{{ URL::TO('admin') }}/src/assets/img/g-8.png" alt="avatar">
                                        </div>
                                        <div class="media-body">
                                    ...
                                    <div class="card-bottom-section">
                                        ...
                                        <div class="img-group">
                                            <img src="{{ URL::TO('admin') }}/src/assets/img/profile-19.jpeg" alt="avatar">
                                            <img src="{{ URL::TO('admin') }}/src/assets/img/profile-6.jpeg" alt="avatar">
                                            <img src="{{ URL::TO('admin') }}/src/assets/img/profile-8.jpeg" alt="avatar">
                                            <img src="{{ URL::TO('admin') }}/src/assets/img/profile-3.jpeg" alt="avatar">
                                        </div>
    ...
    <script src="{{ URL::TO('admin') }}/src/bootstrap/js/bootstrap.bundle.min.js"></script>
    <script src="{{ URL::TO('admin') }}/src/plugins/src/perfect-scrollbar/perfect-scrollbar.min.js"></script>
    <script src="{{ URL::TO('admin') }}/src/plugins/src/mousetrap/mousetrap.min.js"></script>
    <script src="{{ URL::TO('admin') }}/layouts/vertical-dark-menu/app.js"></script>
    <!-- END GLOBAL MANDATORY SCRIPTS -->

    <!-- BEGIN PAGE LEVEL PLUGINS/CUSTOM SCRIPTS -->
    <script src="{{ URL::TO('admin') }}/src/plugins/src/apex/apexcharts.min.js"></script>
    <script src="{{ URL::TO('admin') }}/src/assets/js/dashboard/dash_1.js"></script>
    <!-- BEGIN PAGE LEVEL PLUGINS/CUSTOM SCRIPTS -->
