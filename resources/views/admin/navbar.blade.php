...
<div class="navbar-nav theme-brand flex-row  text-center">
    <div class="nav-logo">
        ...
        <div class="nav-item theme-text">
            <a href="./index.html" class="nav-link"> MEETUPME </a>
        </div>
    </div>
...
<ul class="list-unstyled menu-categories" id="accordionExample">
    ...
    <li class="menu">
        <a href="#fluencer" data-bs-toggle="collapse" aria-expanded="false" class="dropdown-toggle">
            <div class="">
        ...
        <ul class="collapse submenu list-unstyled" id="fluencer" data-bs-parent="#accordionExample">
            <li >
                <a href="./app-blog-grid.html"> Categories </a>
            </li>
            
        </ul>
    </li>
    <li class="menu">
        <a href="#usersmanagement" data-bs-toggle="collapse" aria-expanded="false" class="dropdown-toggle">
            <div class="">
        ...
        <ul class="collapse submenu list-unstyled" id="usersmanagement" data-bs-parent="#accordionExample">
            <li >
                <a href="./app-blog-grid.html"> Categories </a>
            </li>
